...
'Base URL help'						=>	'De volledige URL van het forum zonder "/" aan het eind (bv http://www.example.org/forum). Dit <strong>moet</strong> goed zijn, anders werken beheerder en moderator opties mogelijk niet. Als je errors als "Bad referer" krijgt is dit mogelijk verkeerd ingesteld.',
'Timezone label'					=>	'Standaard tijdzone',
'Timezone help'						=>	'De standaard tijdzone voor gasten en gebruikers die zich registreren.',
...
'Post count help'					=>	'Laat het aantal posts van een gebruiker zien. (heeft effect op topics, profielen en de gebruikerslijst)',
...
'Clickable links help'				=>	'Als dit aan staat zullen alle links automatisch worden vervangen door een klikbare versie.',
...
'SMTP SSL help'						=>	'Encrypt de verbinding met de SMTP server door middel van SSL. Gebruik dit alleen als je SMTP server dit vereist en je versie van PHP ondersteuning bied voor SSL.',
