...
'Update message'				=>	'Je FluxBB database is verouderd en moet worden bijgewerkt om verder te gaan, volg de instructies om de upgrade te voltooien.',
'Note'							=>	'Nota:',
...
'You are running error'			=>	'Je gebruikt %1$s versie %2$s. FluxBB %3$s heeft minstens %1$s %4$s nodig om te werken. Je moet je %1$s installatie upgraden voor je verder kan gaan.',
...
'Current character set'			=>	'<strong>Huidige tekenset:</strong> Als de huidige standaardtaal van je forum Engels is, kan je dit veld leeg laten. Voor andere talen moet je de tekenset van het gebruikte taalpakket invullen in dit veld. <em>Als dit fout is kan je database beschadigd raken, gok niet!</em> Nota: Dit is nodig, ook als je oude database werkt met UTF-8',
